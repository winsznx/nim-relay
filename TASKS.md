...
- [~] Phase 4 — Relay protocol (slice 1: `/api/runs` server-issued challenges + server-verified replay + `game_runs` persistence, deployed. Remaining: relay state machine, `RelayRoom` DO, handoff intents, chain verification, end-to-end TestAlbatross handoff. See `docs/phases/` / `evidence/testnet/phase4-runs.md`)
