import type { HandoffIntent, IssuedRace, RaceMode, RaceTrace, StationSnapshot, StationWorld, SubmittedRace } from '@nim-relay/shared'
...
export const issueRace = (input: { mode: RaceMode; world: StationWorld; target?: string }) => request<IssuedRace>('/issue', input)
