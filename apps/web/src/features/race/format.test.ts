...
import { deltaChip, flowControlPercent, formatSeconds, possessive, verdict } from './format'

const metrics = {
  perfectGates: 0, totalGates: 0, pulseHits: 0, nearMisses: 0, hits: 0, falls: 0, jumps: 0,
  cleanLandings: 0, slides: 0, railTicks: 0, boostPadTicks: 0, riskRoutes: 0, flowSum: 0, flowPeak: 0,
}
